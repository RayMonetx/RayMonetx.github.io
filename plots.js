...
function update()
{
    ...
    //use D3 to reference the value from the dropdowm
    var value = dropdown.property("value"); // produces either 'dataset1' or 'dataset2'

    // set the variables to hold the x and values in arrays
    var x = [];
    var y = [];
...
init(); //calls the init function so that yhe graph gets plotted